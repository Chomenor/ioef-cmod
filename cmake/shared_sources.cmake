...
if(BUILD_ELITEFORCE OR BUILD_NEW_FILESYSTEM)
    list(APPEND COMMON_SOURCES
        ${SOURCE_DIR}/filesystem/fs_commands.c
        ${SOURCE_DIR}/filesystem/fs_download.c
        ${SOURCE_DIR}/filesystem/fs_fileio.c
        ${SOURCE_DIR}/filesystem/fs_filelist.c
        ${SOURCE_DIR}/filesystem/fs_lookup.c
        ${SOURCE_DIR}/filesystem/fs_main.c
        ${SOURCE_DIR}/filesystem/fs_misc.c
        ${SOURCE_DIR}/filesystem/fs_reference.c
        ${SOURCE_DIR}/filesystem/fs_trusted_vms.c
        ${SOURCE_DIR}/filesystem/fscore/fsc_cache.c
        ${SOURCE_DIR}/filesystem/fscore/fsc_crosshair.c
        ${SOURCE_DIR}/filesystem/fscore/fsc_gameparse.c
        ${SOURCE_DIR}/filesystem/fscore/fsc_iteration.c
        ${SOURCE_DIR}/filesystem/fscore/fsc_main.c
        ${SOURCE_DIR}/filesystem/fscore/fsc_md4.c
        ${SOURCE_DIR}/filesystem/fscore/fsc_misc.c
        ${SOURCE_DIR}/filesystem/fscore/fsc_os.c
        ${SOURCE_DIR}/filesystem/fscore/fsc_pk3.c
        ${SOURCE_DIR}/filesystem/fscore/fsc_sha256.c
        ${SOURCE_DIR}/filesystem/fscore/fsc_shader.c
    )
endif()
