...
typedef struct {
	...
	fsc_boolean ( *extract_data )( const fsc_file_t *file, char *buffer, const fsc_filesystem_t *fs, fsc_errorhandler_t *eh );
} fsc_sourcetype_t;
...
char *FSC_ExtractFileAllocated( fsc_filesystem_t *index, fsc_file_t *file, fsc_errorhandler_t *eh );
